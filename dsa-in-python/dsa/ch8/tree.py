...
from dsa.ch7.linked_queue import LinkedQueue
...
class Tree:
    ...
    def children(self, p):
        """Generating an iteration of Positions representing p's children."""
        raise NotImplementedError('must be implemented by subclass')
    ...
    # ---------- traversal ----------
    def positions(self):
        """Generating an iteration of the tree's positions."""
        return self.preorder()      # return entire preorder iteration

    def preorder(self):
        """Generate an preorder iteration of positions in the tree."""
    ...
    def postorder(self):
        """Generate an postorder iteration of positions in the tree."""
        if not self.is_empty():
