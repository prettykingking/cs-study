...
from dsa.ch9.adaptable_priority_queue import AdaptableHeapPriorityQueue
from dsa.ch14.graph import Graph, Vertex


def shortest_path_length(g: Graph, src: Vertex):
    """Compute shortest-path distances from src to reachable vertices of g.

    Graph g can be directed or undirected, but must be weighted such that
