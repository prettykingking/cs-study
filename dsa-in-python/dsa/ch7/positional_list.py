...
class PositionalList(DoublyLinkedBase):
    ...
    class Position:
        ...
        def __init__(self, container, node):
            """Constructor should be invoked by user."""
    ...
    def _insert_between(self, e, predecessor, successor):
        """Add an element between two existing nodes and return new Position."""
        node = super()._insert_between(e, predecessor, successor)
        return self._make_position(node)

    def add_first(self, e):
        """Add an element at the front of the list and return new Position."""
        return self._insert_between(e, self._header, self._header._next)

    def add_last(self, e):
        """Add an element to the back of the list and return new Position."""
    ...
    def replace(self, p, e):
        ...
        """
        origin = self._validate(p)
        old_value = origin._element     # temporarily store old element
